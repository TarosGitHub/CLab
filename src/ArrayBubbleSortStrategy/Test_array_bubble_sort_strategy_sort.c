/**
 * @file      Test_array_bubble_sort_strategy_sort.c
 * @brief     Test for array_bubble_sort_strategy_sort
 * @author    Taro Hoshino
...
void test(int argc, char* argv[])
{
	...
	ArrayBubbleSortStrategy sort_strtgy = new_ArrayBubbleSortStrategy();
